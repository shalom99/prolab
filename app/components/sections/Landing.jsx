      ...
      <div className="lg:flex w-full">
        ...
        <div className="md:w-[70%] h-full md:pl-[10%] flex flex-col justify-center gap-2 md:gap-3">
          ...
          <div className="flex justify-evenly lg:justify-normal gap-2 lg:gap-6">
            <Link href="/" className="grow lg:grow-0 text-center lg:px-5 text-sm font-bold bg-primarybg text-primarytext py-4 rounded-lg hover:bg-darkerbg hover:text-white duration-500">
              APPOINTMENT
            </Link>
        ...
        {/* right */}
        <div className="hidden lg:block w-[40%] h-[90%] 2xl:h-[100%] bg-person1 pb-20 bg-cover bg-no-repeat bg-top rounded-b-full"></div>
      </div>
    </div>
  );
}
