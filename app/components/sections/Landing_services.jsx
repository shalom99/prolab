    ...
    <div className="w-full h-auto xl:w-[80%] 2xl:w-[60%] pt-[50px] lg:pt-[100px] px-[10px]  bg-primarybg ">
      <div className="lg:flex lg:items-center lg:justify-between">
        ...
        <div className="flex gap-5 pr-20">
          <BsChevronLeft
            size={50}
            className="button-prev-slide border border-gray-300 bg-primarybg rounded-full p-3 hover:text-white hover:bg-darkerbg duration-500 "
          />
          <BsChevronRight
            size={50}
            className="button-next-slide border border-gray-300 bg-primarybg rounded-full p-3 hover:text-white hover:bg-darkerbg duration-500 "
          />
        </div>
      </div>
